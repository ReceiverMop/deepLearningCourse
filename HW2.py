...
class GoogLeNet(nn.Module):
    def __init__(self):
        ...
        # 32 + 48 + 24 + 16 = 120
        self.b3 = Inception(32, 128/4/2, 128/4/2/2, 192/4/2, 32/4/2, 96/4/2, 64/4/2)  # 424,092

        self.maxpool = nn.MaxPool2d(3, stride=2, padding=1)

        # 48 + 52 + 12 + 16 = 128
        self.a4 = Inception(60, 192/2-40, 96/2/2, 208/2, 16/2, 48/2, 64/2)
        # 160+224+64+64 = 512
        ...
        self.linear512 = nn.Linear(512/2-40, 10)  # 10250 params
