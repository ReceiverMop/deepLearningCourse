...
# GoogleNet:(             177,   64/4/2, 96/4/2, 128/4/2, 16/4/2, 32/4/2, 32/4/2)  # 165,552 params
...
class GoogLeNet(nn.Module):
    ...
    def forward(self, x):
        ...
        return out, avgPoolOutSize#, maxPoolOutSize, avgpoolPreLayersSize #, xSize, preLayersOutSize, a3OutSize, b3OutSize, maxPoolOutSize, a4OutSize, b4OutSize, c4OutSize, d4OutSize, e4OutSize, maxPool2OutSize, a5OutSize, b5OutSize, avgPoolOutSize
