...
class GoogLeNet(nn.Module):
    def __init__(self):
        ...
        # (1,3,5,6)
        # 16 + 32 + 8 = 64
        self.a3 = Inception(177, 64 / 4 / 2, 96 / 4 / 2, 128 / 4 / 2, 16 / 4 / 2, 32 / 4 / 2,
                            32 / 4 / 2)  # 165,552 params
        # 32 + 48 + 24 + 16 = 120
        ...
        # 48 + 52 + 12 + 16 = 128
        self.a4 = Inception(60, (192 / 1 / 2)+48, (96 / 1 / 2)-10, 208 / 4 / 2, 16 / 1 / 2, 48 / 1 / 2, 64 / 2 / 2)
        # 160+224+64+64 = 512
        ...
        self.linear512 = nn.Linear(162+48, 10)  # 10250 params
...
cnn.load_state_dict(torch.load('./HW2_1.pkl'))
...
print 'Train Accuracy of the model on the %d train images: %.4f %%' % (
train_dataset.train_labels.__len__(), 100 * correct / total)
...
test_dataset.test_labels.__len__(), 100 * correct / total)
